  ...
  return (
    <div className='flex gap-10 my-10'>
        ...
        <div className=''>
            ...
            <div onClick={addBasket} className=' my-4 border w-[200px] text-2xlrounded-md bg-gray-200 cursor-pointer h-16 flex items-center justify-center'>Sepete Ekle</div>
        </div>
    </div>
  )
}
